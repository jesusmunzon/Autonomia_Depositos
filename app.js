// Real demand curves over 24 hours (l/s) matching Excel average magnitudes
        ...
        function updateAlcalaCharts() {
            ...
            const levelOptions = {
                ...
                xaxis: { categories: labels, tickAmount: isPrintMode() ? 7 : 10, tickPlacement: 'between', labels: { rotate: -90, rotateAlways: true, hideOverlappingLabels: true, trim: false, formatter: value => value, style: { fontSize: isPrintMode() ? '6px' : '10px', colors: '#64748b' }, offsetY: isPrintMode() ? 10 : 0 }, tooltip: { enabled: false } },
